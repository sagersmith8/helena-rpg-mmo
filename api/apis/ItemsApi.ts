...
export class ItemsApi extends runtime.BaseAPI {
    ...
    async itemsDeleteRaw(requestParameters: ItemsDeleteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<void>> {
        ...
        if (requestParameters['bonusDamage'] != null) {
            queryParameters['bonus_damage'] = requestParameters['bonusDamage'];
        }

        if (requestParameters['bonusDamageChange'] != null) {
            queryParameters['bonus_damage_change'] = requestParameters['bonusDamageChange'];
        }

        if (requestParameters['repairable'] != null) {
            queryParameters['repairable'] = requestParameters['repairable'];
        }
        ...
        if (requestParameters['armorSlots'] != null) {
            queryParameters['armor_slots'] = requestParameters['armorSlots'];
        }
